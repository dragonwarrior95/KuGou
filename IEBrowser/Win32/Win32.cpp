                     ...
                     int       nCmdShow)
{
	...
	CPaintManagerUI::SetResourceZip(CPaintManagerUI::GetInstancePath()+_T("Win32"));
#else
	CPaintManagerUI::SetResourcePath(CPaintManagerUI::GetInstancePath()+_T("Win32"));
#endif
	...
	if( g_pMainFrame == NULL ) return 0;
	g_pMainFrame->Create(NULL, _T("CMainFrame"), UI_WNDSTYLE_FRAME, WS_EX_WINDOWEDGE);
